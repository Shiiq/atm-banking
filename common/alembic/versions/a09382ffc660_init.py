...
Revision ID: a09382ffc660
Revises: 
Create Date: 2023-05-14 12:56:04.756055
...
def upgrade() -> None:
    ...
    sa.Column('bank_customer', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['bank_customer'], ['bank_customer.id'], name=op.f('fk_bank_operation_bank_customer_bank_customer')),
