...
# from application.usecases import IUsecase
...
from presentation.api.routers import bank_statement_router, deposit_router
...
async def run():
    ...
    async with container.enter_scope(scope=DIScope.APP) as app_state:
        ...
        # app.dependency_overrides[Stub(Mediator)] = mediator.get_deposit_handler
